<%@ Page Title="" Language="C#" MasterPageFile="~/FinalUser.Master" AutoEventWireup="true" CodeBehind="Menu_Display_Ven.aspx.cs" Inherits="ASE_Project.Menu_Display_Ven" %>
   ...
   <!-- <asp:Label ID="goback" runat="server" Text="Label"></asp:Label> !-->
    ...
    <asp:Repeater ID="venmenu" runat="server">
    		...
    		<div style="float:left;width:300px">
              ...
              <a class="green"  href="#?id=<%# DataBinder.Eval(Container.DataItem, "itemid")%>"> Edit Item</a>
               </div>
